    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="record-hearingTest.php" class="active">
              <i class="bi bi-circle"></i><span>Hearing Test</span>
            </a>
          </li>
          <li>
  ...
  if(!$result){
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>".$row['time']."</td>
                <td>
                  <a class='btn' href = 'editHearingTest.php?id=$row[id]'> Edit </a>
                  <a class='btn' href = 'deleteHearingTest.php?id=$row[id]'> Delete </a>
                <td/>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  do{
    ...
    $sql = "INSERT INTO hearingtest (name, email, phone_number, date, time)" . 
